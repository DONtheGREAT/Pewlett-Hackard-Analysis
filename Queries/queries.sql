...
-- because the table did not include employee numbers.
...
--create a table that has only employees that currently work for the company!
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
	de.to_date
...
-- Employee count by department number
-- in order by dept number
SELECT COUNT(ce.emp_no), de.dept_no
--create a table to export with INTO
